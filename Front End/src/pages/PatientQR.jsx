// Frontend/src/pages/PatientQR.jsx
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8 text-center">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">My Patient QR Code</h1>
          <p className="text-gray-600">Use this QR code for quick check-ins and medical appointments</p>
        </div>
                  ...
                  {qrCodeData ? (
                    <div className="w-48 h-48 bg-gray-100 border-2 border-dashed border-gray-300 rounded-lg flex items-center justify-center">
                      ...
                      <div className="text-center">
                        ...
                        <p className="text-xs text-gray-500">QR Code Pattern</p>
                      </div>
                    </div>
                  ) : (
                    <div className="w-48 h-48 bg-gray-100 rounded-lg flex items-center justify-center">
                      <div className="text-center">
                        <svg className="mx-auto h-12 w-12 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 4v1m6 11h2m-6 0h-2v4m0-11v3m0 0h.01M12 12h4.01M16 16h4.01M12 8h4.01M8 12h.01M16 8h.01m-4.01 0h.01M8 16h.01m.01-4h.01m0 4h.01m-4.01-4h.01M4 12h.01M4 16h.01M4 8h.01" />
                        </svg>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between">
                  <span className="text-sm font-medium text-gray-500">Member Number:</span>
                  <span className="text-sm text-gray-900 font-mono">SW{user?.id.slice(-8).toUpperCase()}</span>
                </div>
                <div className="flex justify-between">
            ...
            <div className="bg-blue-50 rounded-lg border border-blue-200 p-6">
              <h3 className="text-lg font-semibold text-blue-900 mb-4">How to Use Your QR Code</h3>
          ...
          <div className="flex items-start">
            ...
            <div>
              ...
              <p className="text-sm text-yellow-700">
                Keep your QR code secure and do not share it with unauthorized individuals. 
                This code contains your personal medical information and should only be used at authorized Swastha facilities.
              </p>
            </div>
          </div>
        </div>
