...
import { Calendar, Users, Clock, MessageSquare, FileText, Settings, Bell, Search, Filter, Eye, Edit, CheckCircle, XCircle, User, Phone, Mail, MapPin, AlertCircle, TrendingUp, Activity, Heart, Thermometer } from 'lucide-react';
...
const DoctorDashboard = () => {
  ...
  const StatCard = ({ icon: Icon, title, value, color = "blue", trend }) => (
    <div className={`bg-white p-6 rounded-xl shadow-lg border-l-4 border-${color}-500 hover:shadow-xl transition-all duration-300 transform hover:scale-105`}>
          ...
          {activeTab === 'dashboard' && (
            <div className="space-y-8">
              <div>
                ...
                <p className="text-gray-600">Welcome back, Dr. Smith. Here's your daily overview.</p>
              </div>
                ...
                <div className="bg-white p-6 rounded-xl shadow-lg">
                  ...
                  <div className="space-y-3">
                    {mockAppointments.slice(0, 3).map(apt => (
                      <div key={apt.id} className="flex items-center justify-between p-3 border border-gray-200 rounded-lg hover:bg-gray-50">
                        <div>
                        ...
                        <tr key={apt.id} className="hover:bg-gray-50">
                          <td className="px-6 py-4 whitespace-nowrap">
                            <div>
                              ...
                              <div className="text-sm text-gray-500">{apt.patientId}</div>
                            </div>
                          </td>
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{apt.time}</td>
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{apt.type}</td>
                          <td className="px-6 py-4 whitespace-nowrap">
                          ...
                          <td className="px-6 py-4 whitespace-nowrap">
                            <span className={`text-sm font-medium ${getUrgencyColor(apt.urgency)}`}>
                              {apt.urgency}
                            </span>
                          </td>
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {mockPatients.map(patient => (
                  <div key={patient.id} className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-all duration-300 transform hover:scale-105">
          ...
          {activeTab === 'messages' && (
            <div className="space-y-6">
              ...
              <div className="bg-white p-8 rounded-lg shadow-md text-center">
                ...
                <p className="text-gray-600">Patient messages will appear here</p>
              </div>
            </div>
          )}
          ...
          {activeTab === 'reports' && (
            <div className="space-y-6">
              ...
              <div className="bg-white p-8 rounded-lg shadow-md text-center">
                ...
                <p className="text-gray-600">Create patient reports, medical summaries, and analytics</p>
              </div>
            </div>
          )}
          ...
          {activeTab === 'settings' && (
            <div className="space-y-6">
              ...
              <div className="bg-white p-8 rounded-lg shadow-md text-center">
                ...
                <h3 className="text-lg font-medium text-gray-900 mb-2">Doctor Settings</h3>
                <p className="text-gray-600">Manage your profile, preferences, and clinic information</p>
              </div>
            </div>
          )}
        </main>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white p-6 rounded-lg shadow-xl max-w-md w-full mx-4">
            ...
            <div className="mt-6 flex space-x-3">
              ...
              <button 
                onClick={() => handleAppointmentAction(selectedAppointment.id, 'reschedule')}
